...
#define PORTA_PIN1_MODE                    PORT_OUTPUT_ALTERNATE_FUNCTION_PUSH_PULL_MAX_SPEED_50MHZ
#define PORTA_PIN2_MODE                    PORT_OUTPUT_GENERAL_PURPOSE_PUSH_PULL_MAX_SPEED_50MHZ
...
/* PortB */
#define PORTB_PIN0_MODE                    PORT_INPUT_PULLING_MODE
#define PORTB_PIN1_MODE                    PORT_INPUT_PULLING_MODE
#define PORTB_PIN2_MODE                    PORT_INPUT_PULLING_MODE
