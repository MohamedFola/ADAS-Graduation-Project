...
#if(PWM_POLARITY==ACTIVE_HIGH)
	CLR_BIT(TIM2->CCER,TIM_CCER_CC1P);


#elif(PWM_POLARITY==ACTIVE_LOW)
...
#error("Wrong PWM Mode")
	...
	/*Set the Polarity of all the channels */
#if(PWM_POLARITY==ACTIVE_HIGH)
	CLR_BIT(TIM2->CCER,TIM_CCER_CC2P);
...
#error("Wrong PWM Mode")
	...
	/*Set the Polarity of all the channels */
#if(PWM_POLARITY==ACTIVE_HIGH)
	CLR_BIT(TIM2->CCER,TIM_CCER_CC3P);
...
#error("Wrong PWM Mode")
	...
	/*Set the Polarity of all the channels */
#if(PWM_POLARITY==ACTIVE_HIGH)
	CLR_BIT(TIM2->CCER,TIM_CCER_CC4P);


#elif(PWM_POLARITY==ACTIVE_LOW)
	SET_BIT(TIM2->CCER,TIM_CCER_CC4P);
#error("Wrong PWM Polarity")
#endif
...
#error("Wrong PWM Mode")
	...
	/*Set the Polarity of all the channels */
#if(PWM_POLARITY==ACTIVE_HIGH)
	CLR_BIT(TIM3->CCER,TIM_CCER_CC2P);
...
#error("Wrong PWM Mode")
	...
	/*Set the Polarity of all the channels */
#if(PWM_POLARITY==ACTIVE_HIGH)
	CLR_BIT(TIM3->CCER,TIM_CCER_CC3P);


#elif(PWM_POLARITY==ACTIVE_LOW)
	SET_BIT(TIM3->CCER,TIM_CCER_CC3P);
#error("Wrong PWM Polarity")
#endif
#endif
...
#error("Wrong PWM Mode")
	...
	/*Set the Polarity of all the channels */
#if(PWM_POLARITY==ACTIVE_HIGH)
	CLR_BIT(TIM3->CCER,TIM_CCER_CC4P);


#elif(PWM_POLARITY==ACTIVE_LOW)
	SET_BIT(TIM3->CCER,TIM_CCER_CC4P);
#error("Wrong PWM Polarity")
#endif
