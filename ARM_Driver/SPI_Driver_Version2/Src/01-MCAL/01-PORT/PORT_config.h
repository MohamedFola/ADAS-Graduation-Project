...
#define PORTB_PIN6_MODE                    PORT_OUTPUT_ALTERNATE_FUNCTION_OPEN_DRAIN_MAX_SPEED_2MHZ
#define PORTB_PIN7_MODE                    PORT_OUTPUT_ALTERNATE_FUNCTION_OPEN_DRAIN_MAX_SPEED_2MHZ
