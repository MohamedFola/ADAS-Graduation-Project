...
#define PORTA_PIN10_MODE                   PORT_OUTPUT_ALTERNATE_FUNCTION_PUSH_PULL_MAX_SPEED_50MHZ
...
#define PORTA_PIN15_MODE                   PORT_OUTPUT_ALTERNATE_FUNCTION_PUSH_PULL_MAX_SPEED_50MHZ
...
/* PortC */
#define PORTC_PIN13_MODE                   PORT_OUTPUT_GENERAL_PURPOSE_PUSH_PULL_MAX_SPEED_10MHZ
